...
export function SinPerdida() {
  ...
  const [desviacionDemanda, setDesviacionDemanda] = useState(21.1); // σD
  const [costoPedido, setCostoPedido] = useState(10); // K
  const [costoInventario, setCostoInventario] = useState(1.4); // h
  const [costoAgotamiento, setCostoAgotamiento] = useState(1.9); // p
  const [tiempoEntrega, setTiempoEntrega] = useState(2); // L
  ...
  const calcularModelo = (e) => {
    ...
    const probAgotamiento = (costoInventario * Q) / (costoAgotamiento * mediaDemanda);
    ...
    const muX = tiempoEntrega * mediaDemanda;
  ...
  return (
    <Contenedor>
      ...
      <Resultados>
        {cantidadOptima ? (
          <ResultadosContainer>
            <Tarjeta titulo="Cantidad Óptima a Pedir (Q*)" valor={cantidadOptima} simbolo="unidades" />
            <Tarjeta titulo="Punto de Reorden (r*)" valor={puntoReorden} simbolo="unidades" />
            <Tarjeta titulo="Nivel de Seguridad" valor={nivelSeguridad} simbolo="unidades" />
